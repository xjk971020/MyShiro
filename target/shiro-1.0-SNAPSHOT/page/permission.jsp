    ...
    <div class="container">
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="permission.jsp" class="navfont">权限列表</a></li>
            </ul>
            </shiro:user>
...
<shiro:user>
    ...
    <div class="col-md-1 col-md-offset-1">
        <input type="button" value="添加权限" class="btn btn-primary" name="create-permission-btn" onclick="createPermission()">
    </div>
    <br/><br/>
    <!-- permission数据表格 -->
    <div class="col-md-10 col-md-offset-1">
        <table class="table table-striped table-hover" id="permission_info_table">
            <thead>
    ...
    <div class="modal fade" id="role-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input hidden="hidden" class="id" value=""/> <!-- 用来存放当前操作权限的id值 -->
                    <!-- 角色-权限的Tree树 -左侧 -->
                    <div class="zTreeDemoBackground" style="float: left;">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">权限名称</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control permission" name="permission" id="role">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">描述信息</label>
